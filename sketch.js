...
function setup() {
	...
	walll= Bodies.rectangle(width/2-110, 550,20,200 , {isStatic:true} );
 	World.add(world, walll);
	 wallr= Bodies.rectangle(width/2+110, 550,20,200 , {isStatic:true} );
	 World.add(world, wallr);
	 wallb= Bodies.rectangle(width/2, 640,200,20 , {isStatic:true} );
